            ...
            <main style={{
                ...
                <div style={{ textAlign: 'center', position: 'relative', zIndex: 2, maxWidth: '700px' }}>
                    ...
                    <div style={{
                        ...
                        <img src="/partners/mgsicon.png" alt="MGS" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                    </div>
                    ...
                    <div style={{
                        ...
                        <span>● DESIGN_PHASE: ACTIVE</span>
                        <span>● FIELD_TRIALS: PENDING</span>
                        <span>● DEPLOYMENT: TBD</span>
                    </div>
